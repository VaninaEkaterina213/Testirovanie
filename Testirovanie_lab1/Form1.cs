...
namespace Testirovanie_lab1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            bool a1 = long.TryParse(textBox1.Text, out long a);
            bool b1 = long.TryParse(textBox2.Text, out long b);
            bool c1 = long.TryParse(textBox3.Text, out long c);
                if ((a1 && b1 && c1) == true)
                {
                    if (a < 1 || b < 1 || c < 1)
                    {
